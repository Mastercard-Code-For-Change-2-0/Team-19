...
import { validateEmail, validatePassword, validateName, combineValidationResults } from '@/utils/validations';
 ...
 const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const registrationData = {
      ...
      role: 'donor', // Default role as 'donor'
    };
    ...
    if (response.data.msg === "User registered successfully") {
      toast({
        ...
        description: `Welcome to DonationHub, ${formData.name}!`,
      });
